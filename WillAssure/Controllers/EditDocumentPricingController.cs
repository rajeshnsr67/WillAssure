...
{
    public class EditDocumentPricingController : Controller
    {
        ...
        public ActionResult EditDocumentPricingIndex()
        {
            ...
            return View("~/Views/EditDocumentPricing/EditDocumentPricingPageContent.cshtml");
        }


        public string BindpriceFormData()
        {
            // check type 
            string typ5 = "";
            con.Open();
        ...
        public string DeletepriceRecords(RoleFormModel RFM)
        {
