    ...
    public class AddRoleAssignmentController : Controller
    {
        ...
        public ActionResult GetAssignRoles(string data, int roleid)
        {
            ...
            else
            {
                ...
                qry = qry + "insert into Assignment_Roles (RoleId,PageName,Nav1,Nav2) values (" + roleid + " ,'WillEmployee','Add Employee~AddWillEmployeeIndex~AddWillEmployee','Edit Employee~EditWillEmployeeIndex~EditWillEmployee')";
                qry = qry + "insert into Assignment_Roles (RoleId,PageName,Nav1,Nav2) values (" + roleid + " ,'DistributorEmployee','Add Employee~AddDistributorEmployeeIndex~AddDistributorEmployee','Edit Employee~EditDistributorEmployeeIndex~EditDistributorEmployee')";
                ...
                qry = qry + "insert into Assignment_Roles (RoleId,PageName,Nav1,Nav2) values (" + roleid + " ,'Document Allotment','Allotment~AddDocumentAllotmentIndex~AddDocumentAllotment','NULL~NULL~NULL')";
                qry = qry + "insert into Assignment_Roles (RoleId,PageName,Nav1,Nav2) values (" + roleid + " ,'Coupon Allotment','Allotment~CouponsAllotmentIndex~CouponsAllotment','NULL~NULL~NULL')";
