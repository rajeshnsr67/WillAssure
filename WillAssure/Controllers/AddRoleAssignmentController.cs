        ...
        public JsonResult CheckRoleId()
        {
            ...
            if (Request["send"] != "")
            {
                ...
                else
                {
                    ...
                    qry = qry + "insert into Assignment_Roles (RoleId,PageName,Nav1,Nav2) values (" + response + " ,'DocumentAllotment','Allotment~AddDocumentAllotmentIndex~AddDocumentAllotment','NULL~NULL~NULL')";
