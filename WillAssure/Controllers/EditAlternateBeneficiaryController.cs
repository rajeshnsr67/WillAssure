...
namespace WillAssure.Controllers
{
    public class EditAlternateBeneficiaryController : Controller
    {
        ...
        public string BindaltbeneficiaryFormData()
        {
            ...
            con.Open();
            string query = "select a.lnk_bd_id , a.bpId , a.First_Name , a.Last_Name , a.Middle_Name , a.DOB , a.Mobile , a.Relationship , a.Marital_Status , a.Religion , a.Identity_Proof , a.Identity_Proof_Value , a.Alt_Identity_Proof , a.Alt_Identity_Proof_Value , a.Address1 , a.Address2 , a.Address3 , a.City , a.State , a.Pin from alternate_Beneficiary a inner join BeneficiaryDetails b on a.bpId = b.bpId inner join TestatorDetails c on b.tId = c.tId inner join  users d on c.uId = d.uId where d.uId = " + Convert.ToInt32(Session["rId"]) + "";
