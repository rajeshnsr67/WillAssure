...
namespace WillAssure.Controllers
{
    public class EditTestatorFamilyController : Controller
    {
        ...
        public string BindTestatorFamilyFormData()
        {
            ...
            con.Open();
            string query = "select a.fId , a.First_Name , a.Last_Name , a.Middle_Name , a.DOB , a.Marital_Status , a.Religion , a.Relationship , a.Address1 , a.Address2 , a.Address3 , a.City , a.State , a.Pin , a.tId , a.active , a.Identity_Proof , a.Identity_Proof_Value , a.Alt_Identity_Proof , a.Alt_Identity_Proof_Value , a.Is_Informed_Person from testatorFamily a inner join TestatorDetails b on a.tId=b.tId where b.uId =  " + Convert.ToInt32(Session["uuid"]) + " ";
