...
namespace WillAssure.Controllers
{
    public class VisitorDataController : Controller
    {
        ...
        public string VisitorDataIndex()
        {
            ...
            con.Open(); 
            string query2 = "insert into users (First_Name , Last_Name , Middle_Name , eMail , Mobile , userID , userPwd , Type , active, rId , compId , Linked_user , Designation , Address1 , Address2 , Address3 , City , State , Pin , DOB) values ('" + name + "' , '" + lastname + "' , '" + middlename + "' , '" + emailid + "' , '" + contactno + "' , '" + emailid + "' , " + userPassword + " , 'Testator','Active' , 5 , 0 , '00' , 2 , 'none' , 'none' , 'none' , 'none', 'none' , 'none' , GETDATE()  )";
            ...
            {
                //generate Mail
                string mailto2 = emailid;
                string userlogin = emailid;
